...
### 1. [AI大模型基础与Transformer架构](./01-ai-model-basics.md)
...
### 2. [大模型预训练技术原理](./02-pretraining-principles.md)
...
### 3. [微调与对齐技术详解](./03-finetuning-alignment.md)
...
### 4. [大模型推理优化技术](./04-inference-optimization.md)
...
### 5. [大模型应用与前沿发展](./05-applications-trends.md)
