...
| **世界模型** | 环境建模、状态预测、想象规划、具身智能 | Dreamer、MuZero、Sora |
...
世界模型让 AI 能够理解环境动态、预测未来状态，是实现具身智能和通用人工智能的关键技术。

::: tip 学习入口
**[→ 进入世界模型学习指南](./world-model/index.md)**
:::
...
| 章节 | 内容 | 难度 |
|------|------|------|
| [基础概念](./world-model/basics.md) | 环境建模、状态表示、预测学习 | ⭐⭐ |
| [架构设计](./world-model/architectures.md) | VAE、RSSM、JEPA、Transformer世界模型 | ⭐⭐⭐ |
| [Dreamer系列](./world-model/dreamer.md) | Dreamer v1/v2/v3、想象规划、RSSM | ⭐⭐⭐ |
| [应用场景](./world-model/applications.md) | 强化学习、机器人、自动驾驶、游戏AI | ⭐⭐⭐ |
| [经典论文](./world-model/papers.md) | World Models、Dreamer、IRIS、UniSim | ⭐⭐⭐ |
...
::: tip 学习入口
**[→ 进入应用与前沿学习指南](../ai-applications/index.md)**
:::
...
| 章节 | 内容 | 难度 |
|------|------|------|
| [RAG检索增强](../ai-applications/rag/index.md) | 向量检索、重排序、高级RAG技术 | ⭐⭐⭐ |
| [AI智能体](../ai-applications/agent/index.md) | 智能体架构、ReAct、工具调用、多智能体协作 | ⭐⭐⭐ |
| [应用案例](../ai-applications/applications/index.md) | 实际应用场景与未来趋势 | ⭐⭐⭐⭐ |
...
| CNN原理 | [CNN详解](/notes/deep-learning/05-cnn.md) |
